	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float3 unpack386 = UnpackNormalScale( tex2D( _BumpMap, uv_BumpMap ), _BumpScale );
				...
				float3 worldNormal77 = normalize( float3(dot(tanToWorld0,tanNormal77), dot(tanToWorld1,tanNormal77), dot(tanToWorld2,tanNormal77)) );
				float3 WorldNormal78 = worldNormal77;
				float dotResult117 = dot( WorldNormal78 , SafeNormalize(_MainLightPosition.xyz) );
				float2 uv_BaseMap = IN.ase_texcoord3.xy * _BaseMap_ST.xy + _BaseMap_ST.zw;
				float4 tex2DNode426 = tex2D( _BaseMap, uv_BaseMap );
				float4 Albedo413 = ( _Color * tex2DNode426 * _Brightness );
				float3 temp_output_387_0 = cross( ase_worldTangent , WorldNormal78 );
				float3 normalizeResult281 = normalize( cross( WorldNormal78 , temp_output_387_0 ) );
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - WorldPosition );
				ase_worldViewDir = SafeNormalize( ase_worldViewDir );
				float3 normalizeResult75 = normalize( ( SafeNormalize(_MainLightPosition.xyz) + ase_worldViewDir ) );
				float3 NHalf76 = normalizeResult75;
				float3 normalizeResult288 = normalize( NHalf76 );
				float dotResult219 = dot( normalizeResult281 , normalizeResult288 );
				float Smoothness23 = _Smoothness;
				float temp_output_57_0 = ( 1.0 - Smoothness23 );
				float temp_output_157_0 = max( ( temp_output_57_0 * temp_output_57_0 ) , 0.01 );
				float Roughness60 = temp_output_157_0;
				float temp_output_253_0 = sqrt( ( 1.0 - _Anisotropic ) );
				float temp_output_195_0 = max( 0.001 , ( Roughness60 / temp_output_253_0 ) );
				float temp_output_201_0 = ( temp_output_195_0 * temp_output_195_0 );
				float3 normalizeResult287 = normalize( temp_output_387_0 );
				float dotResult221 = dot( normalizeResult288 , normalizeResult287 );
				float temp_output_207_0 = max( 0.001 , ( temp_output_253_0 * Roughness60 ) );
				float temp_output_254_0 = ( temp_output_207_0 * temp_output_207_0 );
				float dotResult79 = dot( WorldNormal78 , NHalf76 );
				float temp_output_82_0 = saturate( dotResult79 );
				float temp_output_266_0 = ( ( ( ( dotResult219 * dotResult219 ) / ( temp_output_201_0 * temp_output_201_0 * _AnisoTBStrength ) ) + ( ( dotResult221 * dotResult221 ) / ( temp_output_254_0 * temp_output_254_0 * _AnisoTBStrength ) ) ) + ( temp_output_82_0 * temp_output_82_0 ) );
				float SpeculatAnis382 = ( 1.0 / ( ( ( temp_output_266_0 * temp_output_266_0 ) * PI * ( temp_output_201_0 * temp_output_254_0 ) ) + 0.04 ) );
				float3 bakedGI126 = ASEBakedGI( WorldNormal78, float2( 0,0 ), true);
				...
				float dotResult144 = dot( WorldNormal78 , ase_worldViewDir );
				float saferPower422 = max( ( 1.0 - saturate( dotResult144 ) ) , 0.0001 );
				float lerpResult139 = lerp( 0.04 , Smoothness23 , saturate( pow( saferPower422 , 4.0 ) ));
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( ( ase_lightAtten * float4( _MainLightColor.rgb , 0.0 ) * ( ( saturate( dotResult117 ) * Albedo413 ) + ( _SpecColor * SpeculatAnis382 ) ) ) + ( ( Albedo413 * float4( bakedGI126 , 0.0 ) ) + float4( ( indirectSpecular128 * lerpResult139 ) , 0.0 ) ) ).rgb;
...
/*ASEBEGIN
Version=18900
279;553;1372;677;6500.013;751.0629;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;165;-6634.989,247.7177;Inherit;False;Property;_Smoothness;平滑度;3;0;Create;False;0;0;0;False;0;False;0.5;0.36;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;386;-6236.012,-458.082;Inherit;True;Property;_BumpMap;法线;6;0;Create;False;0;0;0;False;0;False;-1;None;551b2b916266a2f4082d3ffd3546e3fc;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;392;-6506.201,-408.7926;Inherit;False;Property;_BumpScale;法线强度;7;0;Create;False;0;0;0;False;0;False;0;0.5;-2;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;36;-608.5255,-1823.587;Inherit;False;Property;_Color;颜色;0;0;Create;False;0;0;0;False;0;False;0.5019608,0.5019608,0.5019608,0;0.1226415,0.1226415,0.1226415,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;426;-696.9637,-1645.881;Inherit;True;Property;_BaseMap;基础图;2;0;Create;False;0;0;0;False;0;False;-1;None;737f4615796b867419657b1de36b7bbf;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;185;-5638.463,-31.13234;Inherit;False;Property;_Anisotropic;各向异性;4;0;Create;False;0;0;0;False;0;False;0;0.445;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;421;-722.6678,-853.8369;Inherit;False;Property;_SpecColor;高光颜色;8;0;Create;False;0;0;0;False;0;False;0,0,0,0;0.09433959,0.09433959,0.09433959,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;284;-4784.665,-63.12694;Inherit;False;Property;_AnisoTBStrength;AnisoTBStrength;5;0;Create;True;0;0;0;False;0;False;1;3.681765;1;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.VertexTangentNode;389;-5743.065,-614.4556;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;593.7344,-718.1688;Half;False;True;-1;2;ASEMaterialInspector;0;3;VG/ASE/Role/Hair_Anisotropic_Blend;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;0;0;False;True;1;5;False;-1;10;False;-1;1;1;False;-1;10;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;True;2;False;-1;True;0;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForward;False;0;Hidden/InternalErrorShader;0;0;Standard;22;Surface;1;  Blend;0;Two Sided;1;Cast Shadows;1;  Use Shadow Threshold;0;Receive Shadows;1;GPU Instancing;1;LOD CrossFade;0;Built-in Fog;0;DOTS Instancing;0;Meta Pass;0;Extra Pre Pass;0;Tessellation;0;  Phong;0;  Strength;0.5,False,-1;  Type;0;  Tess;16,False,-1;  Min;10,False,-1;  Max;25,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Vertex Position,InvertActionOnDeselection;1;0;5;False;True;True;True;False;False;;False;0
...
ASEEND*/
//CHKSM=4D021AEBA5637E5082A7C175E880FC2DB9ECEBFC